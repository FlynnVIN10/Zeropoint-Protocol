import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, ref, computed, useAttrs, toValue, defineComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, useSSRContext, resolveComponent, unref, provide, onErrorCaptured, onServerPrefetch, createApp } from "/Users/Flynn/Documents/GitHub/Zeropoint-Protocol/web/node_modules/vue/index.mjs";
import { $fetch as $fetch$1 } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/Flynn/Documents/GitHub/Zeropoint-Protocol/web/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/Flynn/Documents/GitHub/Zeropoint-Protocol/web/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/Flynn/Documents/GitHub/Zeropoint-Protocol/web/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1 } from "vue-router";
import { toRouteMatcher, createRouter } from "/Users/Flynn/Documents/GitHub/Zeropoint-Protocol/web/node_modules/radix3/dist/index.mjs";
import { defu, defuFn, createDefu } from "/Users/Flynn/Documents/GitHub/Zeropoint-Protocol/web/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "/Users/Flynn/Documents/GitHub/Zeropoint-Protocol/web/node_modules/ufo/dist/index.mjs";
import { createSharedComposable } from "@vueuse/core";
import { extendTailwindMerge, twJoin } from "tailwind-merge";
import { klona } from "/Users/Flynn/Documents/GitHub/Zeropoint-Protocol/web/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/Users/Flynn/Documents/GitHub/Zeropoint-Protocol/web/node_modules/@unhead/vue/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader } from "@iconify/vue";
import { ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrRenderSuspense } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CE1RXfm0.js")
  },
  {
    name: "audits",
    path: "/audits",
    component: () => import("./_nuxt/audits-C_KJClPP.js")
  },
  {
    name: "status",
    path: "/status",
    component: () => import("./_nuxt/status-uN1AjqFG.js")
  },
  {
    name: "library",
    path: "/library",
    component: () => import("./_nuxt/library-GlLoKH8a.js")
  },
  {
    name: "metrics",
    path: "/metrics",
    component: () => import("./_nuxt/metrics-BGCXQ9Pu.js")
  },
  {
    name: "consensus",
    path: "/consensus",
    component: () => import("./_nuxt/consensus-BHvtfSx-.js")
  },
  {
    name: "governance",
    path: "/governance",
    component: () => import("./_nuxt/governance-BWeda2YB.js")
  },
  {
    name: "legal-terms",
    path: "/legal/terms",
    component: () => import("./_nuxt/terms-DF72LDPL.js")
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-CPs9Q5G9.js").then((r) => r["default"] || r.default || r));
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UNavigationMenu = resolveComponent("UNavigationMenu");
      const _component_USeparator = resolveComponent("USeparator");
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UContainer, { class: "min-h-screen" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UHeader, { ui: { wrapper: "max-w-6xl mx-auto px-4" } }, {
                    left: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="w-4 h-4 rounded bg-[var(--ui-color-link)] mr-2"${_scopeId3}></div><strong${_scopeId3}>Zeropoint</strong>`);
                      } else {
                        return [
                          createVNode("div", { class: "w-4 h-4 rounded bg-[var(--ui-color-link)] mr-2" }),
                          createVNode("strong", null, "Zeropoint")
                        ];
                      }
                    }),
                    right: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_UNavigationMenu, { items: [
                          { label: "Home", to: "/" },
                        ...
                        return [
                          createVNode(_component_UNavigationMenu, { items: [
                            { label: "Home", to: "/" },
                            { label: "Status", to: "/status" },
                            { label: "Metrics", to: "/metrics" },
                            { label: "Consensus", to: "/consensus" },
                  ...
                  _push3(`<main class="max-w-6xl mx-auto px-4 py-8"${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push3, _parent3, _scopeId2);
                  _push3(`</main>`);
                  _push3(ssrRenderComponent(_component_USeparator, null, null, _parent3, _scopeId2));
                  _push3(`<footer class="max-w-6xl mx-auto px-4 py-6 text-sm text-zinc-400"${_scopeId2}> © Zeropoint Protocol. GOD FIRST. </footer>`);
                } else {
                  return [
                    createVNode(_component_UHeader, { ui: { wrapper: "max-w-6xl mx-auto px-4" } }, {
                      left: withCtx(() => [
                        createVNode("div", { class: "w-4 h-4 rounded bg-[var(--ui-color-link)] mr-2" }),
                        createVNode("strong", null, "Zeropoint")
                      ]),
                    ...
                    createVNode("main", { class: "max-w-6xl mx-auto px-4 py-8" }, [
                      renderSlot(_ctx.$slots, "default")
                    ]),
                    createVNode(_component_USeparator),
                    createVNode("footer", { class: "max-w-6xl mx-auto px-4 py-6 text-sm text-zinc-400" }, " © Zeropoint Protocol. GOD FIRST. ")
                  ];
                }
              }),
              _: 3
            ...
            return [
              createVNode(_component_UContainer, { class: "min-h-screen" }, {
                default: withCtx(() => [
                  createVNode(_component_UHeader, { ui: { wrapper: "max-w-6xl mx-auto px-4" } }, {
                    left: withCtx(() => [
                      createVNode("div", { class: "w-4 h-4 rounded bg-[var(--ui-color-link)] mr-2" }),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Ci45xIpM.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DgVeCQiZ.js"));
