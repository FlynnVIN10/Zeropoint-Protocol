    ...
    <div className="max-w-4xl mx-auto space-y-8 p-8">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600">
          Comprehensive legal framework for the Zeropoint Protocol platform
        </p>
      </div>

      <section className="bg-white p-8 rounded-lg shadow-md">
        <h2 className="text-2xl font-semibold mb-6">Proprietary License — Zeropoint Protocol: Dual Consensus Agentic AI Platform</h2>
        <p className="mb-4">
          This software is licensed to customers under the Zeropoint Protocol Commercial License (&quot;ZPCL&quot;).
          You receive a non-exclusive, non-transferable, revocable license to deploy the Appliance and associated software for internal use.
          No redistribution, sublicensing, or model weight transfer outside permitted scopes. CEO-as-final-consensus governance is mandatory.
        </p>
        
        <div className="mb-4">
          <p><strong>Scope:</strong> Control Center UI, Orchestrator, Synthients runtime, governance modules, integration kits.</p>
          <p><strong>Restricted:</strong> Model checkpoints trained with licensed datasets, red-team kits, safety gates.</p>
          <p><strong>Attribution:</strong> Include &quot;Powered by Zeropoint Protocol — Dual Consensus Agentic AI Platform&quot; in UIs unless whitelabel addendum applies.</p>
          <p><strong>Telemetry:</strong> Opt-in only.</p>
          <p><strong>Support:</strong> As per order form and SOW.</p>
        </div>

        <div className="bg-gray-50 p-4 rounded">
          <h3 className="font-semibold mb-2">Current License Bundle</h3>
          <div className="grid md:grid-cols-3 gap-4">
            <div><strong>Version:</strong> v1</div>
            <div><strong>Commit:</strong> {process.env.NEXT_PUBLIC_LICENSE_COMMIT || 'unknown'}</div>
            <div><strong>Effective date:</strong> 2025-08-13</div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white p-8 rounded-lg shadow-md">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li><strong>Acceptable Use:</strong> No training or deployment for unlawful, discriminatory, or deceptive purposes.</li>
          <li><strong>Security:</strong> Report vulnerabilities to security@zeropointprotocol.ai.</li>
          <li><strong>Privacy:</strong> No collection of personal data unless necessary; data minimization enforced.</li>
        </ul>
      </section>
