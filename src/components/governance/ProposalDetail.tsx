  ...
  return (
    <div className="p-4">
      ...
      {p.status === 'synthient-review' ? (
        ...
        <div className="text-center">
          <div className="px-4 py-2 rounded-lg font-semibold bg-emerald-600/20 text-emerald-300 border border-emerald-500/30">
            Proposal ✅ APPROVED
          </div>
        ...
        <div className="text-center">
          <div className="px-4 py-2 rounded-lg font-semibold bg-amber-600/20 text-amber-300 border border-amber-500/30">
            Proposal ❌ REJECTED
          </div>
          <div className="text-xs text-zinc-400 mt-2">
        ...
        <div className="space-y-2">
          {/* Legacy 'open' status - show voting status */}
          <div className="text-xs text-zinc-400">
            Human: {p.votes?.find(v => v.actor === 'human')?.decision || 'pending'} | 
            Synthient: {p.votes?.find(v => v.actor === 'synthient')?.decision || 'pending'}
          </div>
        ...
        <div className="text-center">
          <div className="px-4 py-2 rounded-lg font-semibold bg-gray-600/20 text-gray-300 border border-gray-500/30">
            Unknown Status: {p.status}
          </div>
        </div>
      )}
    </div>
