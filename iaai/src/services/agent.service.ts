...
export class AgentService {
        ...
        pending: [
          {
            ...
            justification:
              "Current response times exceed acceptable thresholds",
          },
        ],
        approved: [
          {
            ...
            justification:
              "Model accuracy has degraded by 5% in recent evaluations",
          },
        ],
        rejected: [
          {
            ...
            estimatedImpact: "high" as const,
            justification:
              "Current resources insufficient for training requirements",
          },
        ],
      };
    ...
    try {
      ...
      const metrics = {
        ...
        trends: {
          ...
          accuracy: [0.89, 0.9, 0.91, 0.91, 0.92],
  ...
  private async storeAgentRequest(
    ...
    console.log(
      `Storing agent request ${requestId} for user ${userId}:`,
      request,
    );
  }
