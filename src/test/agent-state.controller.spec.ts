...
const mockSynthientGuard = SynthientGuard as jest.MockedClass<
  typeof SynthientGuard
>;
...
describe("AgentStateController (Integration)", () => {
  ...
  describe("POST /v1/agent-states", () => {
    ...
    it("should create a new agent state", async () => {
      ...
      expect(mockAgentStateService.createAgentState).toHaveBeenCalledWith(
        createDto,
      );
    });
  ...
  describe("GET /v1/agent-states/:agentId", () => {
    it("should return agent state by ID", async () => {
      ...
      expect(response.body).toEqual(mockAgentState);
      expect(mockAgentStateService.getAgentState).toHaveBeenCalledWith(
        "test-agent",
      );
    });
  ...
  describe("PUT /v1/agent-states/:agentId", () => {
    ...
    it("should update agent state", async () => {
      ...
      expect(mockAgentStateService.updateAgentState).toHaveBeenCalledWith(
        "test-agent",
        updateDto,
      );
    });
  ...
  describe("DELETE /v1/agent-states/:agentId", () => {
    it("should delete agent state", async () => {
      ...
      expect(mockAgentStateService.deleteAgentState).toHaveBeenCalledWith(
        "test-agent",
      );
    });
  });
  ...
  describe("GET /v1/agent-states/ethical/:rating", () => {
    it("should return agents by ethical rating", async () => {
      mockAgentStateService.getAgentsByEthicalRating.mockResolvedValue([
        mockAgentState,
      ]);
      ...
      expect(response.body).toEqual([mockAgentState]);
      expect(
        mockAgentStateService.getAgentsByEthicalRating,
      ).toHaveBeenCalledWith("aligned");
    });
  });

  describe("GET /v1/agent-states/attention/required", () => {
    it("should return agents requiring attention", async () => {
      mockAgentStateService.getAgentsRequiringAttention.mockResolvedValue([
        mockAgentState,
      ]);
      ...
      expect(response.body).toEqual([mockAgentState]);
      expect(
        mockAgentStateService.getAgentsRequiringAttention,
      ).toHaveBeenCalled();
    });
  });
  ...
  describe("POST /v1/agent-states/:agentId/training", () => {
    ...
    it("should record training cycle", async () => {
      mockAgentStateService.recordTrainingCycle.mockResolvedValue(
        mockAgentState,
      );
  ...
  describe("POST /v1/agent-states/:agentId/performance", () => {
    ...
    it("should record performance metric", async () => {
      mockAgentStateService.recordPerformanceMetric.mockResolvedValue(
        mockAgentState,
      );
      ...
      expect(response.body).toEqual(mockAgentState);
      expect(
        mockAgentStateService.recordPerformanceMetric,
  ...
  describe("POST /v1/agent-states/:agentId/violations", () => {
    ...
    it("should record ethical violation", async () => {
      mockAgentStateService.recordEthicalViolation.mockResolvedValue(
        mockAgentState,
      );
